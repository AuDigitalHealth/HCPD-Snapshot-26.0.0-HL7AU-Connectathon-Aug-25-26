...
* extension[=].valueCodeableConcept = https://healthterminologies.gov.au/fhir/CodeSystem/new-patient-availability-1#accepting "Accepting new patients"
...
* identifier[HCPD_Source_Identifier].value = "HS-PCA-001234"
