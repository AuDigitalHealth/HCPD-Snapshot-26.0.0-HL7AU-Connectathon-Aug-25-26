...
// HCPD Source Identifier (as per profile slice)
...
* identifier[HCPD_Source_Identifier].value = "EP-NHSD-001234567890"
...
// Endpoint URL
* address = "https://example.org/smd-sydneyhospital/secure-messaging/endpoint"
