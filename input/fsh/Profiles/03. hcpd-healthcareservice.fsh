...
* extension[iar-levels-of-care] ^extension[=].extension[=].valueCode = #SHOULD:handle
* extension[iar-levels-of-care] ^extension[=].extension[+].url = "actor"
* extension[iar-levels-of-care] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* extension[new-patient-availability] ^extension[=].extension[=].valueCode = #SHOULD:handle
* extension[new-patient-availability] ^extension[=].extension[+].url = "actor"
* extension[new-patient-availability] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* extension[referral-information-for-referrer] ^extension[=].extension[=].valueCode = #SHOULD:handle
* extension[referral-information-for-referrer] ^extension[=].extension[+].url = "actor"
* extension[referral-information-for-referrer] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* identifier ^extension[=].extension[=].valueCode = #SHOULD:handle
* identifier ^extension[=].extension[+].url = "actor"
* identifier ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"

* identifier contains HCPD_Source_Identifier 1..1 MS and HCPD_Local_Identifier 1..1 MS

* identifier[HCPD_Source_Identifier] only HCPD_Source_Identifier 
* identifier[HCPD_Source_Identifier] ^short = "Identifier attributed from source system. Source for HealthcareService: PCA."
* identifier[HCPD_Source_Identifier] ^definition = "Unique identifier for the HealthcareService attributed from source system. Not exposed externally but can be used for system reference or internal business logic."
* identifier[HCPD_Source_Identifier] ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[+].url = "code"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[=].valueCode = #SHALL:populate-if-known
* identifier[HCPD_Source_Identifier] ^extension[=].extension[+].url = "actor"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/responder-actor-health-connect"
* identifier[HCPD_Source_Identifier] ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[+].url = "code"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[=].valueCode = #SHOULD:handle
* identifier[HCPD_Source_Identifier] ^extension[=].extension[+].url = "actor"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/requester-actor-health-connect"
* identifier[HCPD_Source_Identifier] ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[+].url = "code"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[=].valueCode = #SHOULD:handle
* identifier[HCPD_Source_Identifier] ^extension[=].extension[+].url = "actor"
* identifier[HCPD_Source_Identifier] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* identifier[HCPD_Local_Identifier] ^extension[=].extension[=].valueCode = #SHOULD:handle
* identifier[HCPD_Local_Identifier] ^extension[=].extension[+].url = "actor"
* identifier[HCPD_Local_Identifier] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"

* active 1..1 MS
* active ^short = "Specifying the service status. Only active services are exposed externally and discoverable/visible in the directory."
* active ^definition = "When provided, it will show if the service is currently active and ensure that only active services are made discoverable/visible in the directory."
* active ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* active ^extension[=].extension[+].url = "code"
* active ^extension[=].extension[=].valueCode = #SHALL:populate-if-known
* active ^extension[=].extension[+].url = "actor"
* active ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/responder-actor-health-connect"
* active ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* active ^extension[=].extension[+].url = "code"
* active ^extension[=].extension[=].valueCode = #SHOULD:handle
* active ^extension[=].extension[+].url = "actor"
* active ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/requester-actor-health-connect"
* active ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* active ^extension[=].extension[+].url = "code"
* active ^extension[=].extension[=].valueCode = #SHOULD:handle
* active ^extension[=].extension[+].url = "actor"
* active ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* providedBy ^extension[=].extension[=].valueCode = #SHOULD:handle
* providedBy ^extension[=].extension[+].url = "actor"
* providedBy ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* type ^extension[=].extension[=].valueCode = #SHOULD:handle
* type ^extension[=].extension[+].url = "actor"
* type ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
* type ^extension[=].extension[+].url = "http://hl7.org/fhir/tools/StructureDefinition/snapshot-source"
* type ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/StructureDefinition/hcpd-healthcareservice"
* type.coding 1..* MS
...
* type.coding ^extension[=].extension[=].valueCode = #SHOULD:handle
* type.coding ^extension[=].extension[+].url = "actor"
* type.coding ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* type.coding.code ^extension[=].extension[=].valueCode = #SHOULD:handle
* type.coding.code ^extension[=].extension[+].url = "actor"
* type.coding.code ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* location ^extension[=].extension[=].valueCode = #SHOULD:handle
* location ^extension[=].extension[+].url = "actor"
* location ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* comment ^extension[=].extension[=].valueCode = #SHOULD:handle
* comment ^extension[=].extension[+].url = "actor"
* comment ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* telecom ^extension[=].extension[=].valueCode = #SHOULD:handle
* telecom ^extension[=].extension[+].url = "actor"
* telecom ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
* telecom ^extension[=].extension[+].url = "http://hl7.org/fhir/tools/StructureDefinition/snapshot-source"
* telecom ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/StructureDefinition/hcpd-healthcareservice"
...
* coverageArea ^extension[=].extension[=].valueCode = #SHOULD:handle
* coverageArea ^extension[=].extension[+].url = "actor"
* coverageArea ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* serviceProvisionCode ^extension[=].extension[=].valueCode = #SHOULD:handle
* serviceProvisionCode ^extension[=].extension[+].url = "actor"
* serviceProvisionCode ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* communication ^extension[=].extension[=].valueCode = #SHOULD:handle
* communication ^extension[=].extension[+].url = "actor"
* communication ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* appointmentRequired ^extension[=].extension[=].valueCode = #SHOULD:handle
* appointmentRequired ^extension[=].extension[+].url = "actor"
* appointmentRequired ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* availableTime ^extension[=].extension[=].valueCode = #SHOULD:handle
* availableTime ^extension[=].extension[+].url = "actor"
* availableTime ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* availableTime.daysOfWeek ^extension[=].extension[=].valueCode = #SHOULD:handle
* availableTime.daysOfWeek ^extension[=].extension[+].url = "actor"
* availableTime.daysOfWeek ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* availableTime.allDay ^extension[=].extension[=].valueCode = #SHOULD:handle
* availableTime.allDay ^extension[=].extension[+].url = "actor"
* availableTime.allDay ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* availableTime.availableStartTime ^extension[=].extension[=].valueCode = #SHOULD:handle
* availableTime.availableStartTime ^extension[=].extension[+].url = "actor"
* availableTime.availableStartTime ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* availableTime.availableEndTime ^extension[=].extension[=].valueCode = #SHOULD:handle
* availableTime.availableEndTime ^extension[=].extension[+].url = "actor"
* availableTime.availableEndTime ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* notAvailable ^extension[=].extension[=].valueCode = #SHOULD:handle
* notAvailable ^extension[=].extension[+].url = "actor"
* notAvailable ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* notAvailable.description ^extension[=].extension[=].valueCode = #SHOULD:handle
* notAvailable.description ^extension[=].extension[+].url = "actor"
* notAvailable.description ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* notAvailable.during ^extension[=].extension[=].valueCode = #SHOULD:handle
* notAvailable.during ^extension[=].extension[+].url = "actor"
* notAvailable.during ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* eligibility ^extension[=].extension[=].valueCode = #SHOULD:handle
* eligibility ^extension[=].extension[+].url = "actor"
* eligibility ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
* eligibility.code MS
* eligibility.code from https://healthterminologies.gov.au/fhir/ValueSet/service-eligibility-2 (required)
...
* eligibility.code ^extension[=].extension[=].valueCode = #SHOULD:handle
* eligibility.code ^extension[=].extension[+].url = "actor"
* eligibility.code ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* extension[active-period] ^extension[=].extension[=].valueCode = #SHOULD:handle
* extension[active-period] ^extension[=].extension[+].url = "actor"
* extension[active-period] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
...
* endpoint ^extension[=].extension[=].valueCode = #SHOULD:handle
* endpoint ^extension[=].extension[+].url = "actor"
* endpoint ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/ActorDefinition/bulk-export-requester-actor-health-connect"
